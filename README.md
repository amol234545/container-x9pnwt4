...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x9pnwt4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x9pnwt4.containers.anotherwebservice.com/
...
```
git clone git@github.com:amol234545/container-x9pnwt4.git
cd container-x9pnwt4
```
...
```
docker attach container-x9pnwt4
```
